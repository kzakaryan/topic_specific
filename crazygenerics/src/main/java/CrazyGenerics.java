...
public class CrazyGenerics {
     ...
     */
    interface ComparableCollection<E> extends Collection<E>, Comparable<ComparableCollection<E>> {
    ...
    static class CollectionUtil {
        ...
        public static <T extends BaseEntity> boolean isValidCollection(
                Collection<T> entities, Predicate<T> validationPredicate) {
        ...
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) {
            return findMax(entities, (Comparator<T>) (Comparator<?>) CREATED_ON_COMPARATOR)
        ...
        public static void swap(List<Object> elements, int i, int j) {
            ...
            List<Object> tempList = new ArrayList<>(elements);
